...
B0:
	...
	11: Call start_auction<EUR, Car>(&signer, Asset<EUR>, Car)
	12: Ret
}
public bid<AssetType, ItemType: store>(acc: &signer, auctioneer: address, assets: Asset<AssetType>) /* def_idx: 1 */ {
...
B2:
	...
	13: Call bid<EUR, Car>(&signer, address, Asset<EUR>)
...
B3:
	...
	21: Call retrieve_prize<EUR, Car>(&signer, address): Car
	22: StLoc[4](car: Car)
...
B0:
	...
	1: Call finalize_auction<EUR, Car>(&signer)
	2: Ret
}
public finalize_auction<AssetType, ItemType: store>(acc: &signer) /* def_idx: 4 */ {
...
public start_auction<AssetType, ItemType: store>(acc: &signer, base: Asset<AssetType>, item: ItemType) /* def_idx: 5 */ {
...
public retrieve_prize<AssetType, ItemType: store>(acc: &signer, auctioneer: address): ItemType /* def_idx: 6 */ {
L2:	self: address
L3:	expired: bool
